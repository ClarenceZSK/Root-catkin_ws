...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'data_generator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clarence/catkin_ws/src/data_generator/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
