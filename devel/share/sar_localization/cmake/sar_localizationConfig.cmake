...
if("TRUE" STREQUAL "TRUE")
  set(sar_localization_SOURCE_PREFIX /root/catkin_ws/src/sar_localization)
  set(sar_localization_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(sar_localization_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'sar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/sar_localization/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
