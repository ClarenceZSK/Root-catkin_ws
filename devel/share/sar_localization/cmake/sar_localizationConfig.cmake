...
if("TRUE" STREQUAL "TRUE")
  set(sar_localization_SOURCE_PREFIX /home/clarence/catkin_ws/src/sar_localization)
  set(sar_localization_DEVEL_PREFIX /home/clarence/catkin_ws/devel)
  ...
  set(sar_localization_INSTALL_PREFIX /home/clarence/catkin_ws/install)
...
if(NOT "/home/clarence/catkin_ws/devel/include " STREQUAL " ")
  set(sar_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/clarence/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sar_localization' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clarence/catkin_ws/src/sar_localization/${idir}'.  Ask the maintainer 'root <root@todo.todo>' to fix it.")
    endif()
