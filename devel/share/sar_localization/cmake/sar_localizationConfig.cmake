...
if(NOT "/root/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'sar_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/sar_localization/${idir}'.  Ask the maintainer 'clarence <clarence@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /root/catkin_ws/devel/lib;/root/catkin_ws/devel/lib;/home/clarence/SAR_Localization/devel/lib;/opt/ros/hydro/lib)
