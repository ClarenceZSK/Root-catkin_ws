...
(cl:defmethod cl:initialize-instance :after ((m <Imu>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Imu)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sar_localization-msg:<Imu> is deprecated: use sar_localization-msg:Imu instead.")))
...
(cl:defmethod yaw-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sar_localization-msg:yaw-val is deprecated.  Use sar_localization-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sar_localization-msg:pitch-val is deprecated.  Use sar_localization-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <Imu>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sar_localization-msg:roll-val is deprecated.  Use sar_localization-msg:roll instead.")
  (roll m))
