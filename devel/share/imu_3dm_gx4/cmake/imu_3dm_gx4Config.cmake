...
if("TRUE" STREQUAL "TRUE")
  set(imu_3dm_gx4_SOURCE_PREFIX /root/catkin_ws/src/imu_3dm_gx4)
  set(imu_3dm_gx4_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(imu_3dm_gx4_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/imu_3dm_gx4/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
    endif()
