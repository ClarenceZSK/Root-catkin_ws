...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_3dm_gx4' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/clarence/catkin_ws/install/${idir}'.  Ask the maintainer 'gcross <gcross.code@icloud.com>' to fix it.")
    endif()
